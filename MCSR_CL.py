...
def Recommendation_items_Top_k(fused_embeddings, user_id_map, data, threshold_func=None, top_k=10):
...
def evaluate_RS_Model(fused_embeddings, user_id_map, file_path, criteria, test_size=0.2, random_state=42):
    ...
    train_recommendations = Recommendation_items_Top_k(fused_embeddings, user_id_map, data, threshold_func=threshold_function, top_k=10)
    ...
    test_user_indices = [index for index in test_user_indices if index != -1]

    # Index fused_embeddings with test user indices
    test_X = fused_embeddings[test_user_indices]
...
if __name__ == "__main__":
    ...
    #     'BeerAdvocate': '/home/z5318340/MCRS4/BeerAdvocate22.xlsx',
    #     'TripAdvisor': '/home/z5318340/MCRS4/Custmoze_Tripadvisor3.xlsx'
    # }
    ...
    recommendations = Recommendation_items_Top_k(fused_embeddings, user_id_map, data, threshold_func=None, top_k=10)

    # # # Print recommendations for each user
    # for user_id, recommended_items in recommendations.items():
    #     print(f"Recommendations for User {user_id}:".encode('utf-8'))  # Add UTF-8 encoding here
    #     for idx, item in enumerate(recommended_items, start=1):
    #         print(f"{idx}. Item ID: {item['item_id']}, Overall Rating: {item['Overall_Rating']}".encode('utf-8'))  # Add UTF-8 encoding here
    #     print()
